 ...
 *
 * 	The resource server is located at "/media", and can be accessed only by retrieving a token from "/oauth/token"
...
public class OAuth2SecurityConfiguration {
	 ...
	 *	resource server (i.e. the "/media" endpoint) 
	 */
	@Configuration
	...
	protected static class ResourceServer extends
		...
		// all of the paths in the media service.
		@Override
	...
	protected static class OAuth2Config extends
		 ...
		 * passwords listed below and updating the MediaSvcClientApiTest.
		 * 
		 * @param auth
		 * @throws Exception
		 */
